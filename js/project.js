...
let privateRepo = document.querySelectorAll('.privateRepo');

privateRepo.forEach((repo) => {
  repo.addEventListener('mouseover', (e) => {
    repo.classList.remove('pointer-events-none');
